...
Cette application a été conçue par **Mory Diouf**, étudiant en master de mathématiques pures.

Elle est développée en suivant la méthodologie du professeur pour l'analyse des systèmes dynamiques :
